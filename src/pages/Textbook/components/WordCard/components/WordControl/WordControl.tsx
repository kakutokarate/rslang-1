...
const WordControl: FC<IWordControlProps> = ({ mode, isDifficult, onDifficultClick, onDeleteWord }) => {
  ...
  return (
    <StyledWordControl>
      {mode === 'textbook' && (
        <>
          <button onClick={onDifficultClick} disabled={isDisabled}>Сложное слово</button>
